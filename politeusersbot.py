...
def run_bot():
    ...
    for comment in comments:
        ...
        if comment.id not in cache and isMatch:
            ...
            comment.reply("Thank you for being a polite user on reddit! \n\n*This bot was created by [kooldawgstar](http://reddit.com/u/kooldawgstar), if this bot is an annoyance to your subreddit feel free to ban it or message me and I will add it to the blacklist.*")
